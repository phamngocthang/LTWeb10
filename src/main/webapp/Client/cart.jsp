			                            ...
			                            <td class="align-middle">
			                                <div class="input-group quantity mx-auto" style="width: 100px;">
			                                    <div class="input-group-btn">
			                                        <button class="btn btn-sm btn-primary btn-minus" onclick="location.href='subAmountCart?productID=${p.id_P}&amount=${c.amount}';">
			                                        <i class="fa fa-minus"></i>
			                                        </button>
			                                    </div>
			                                    <input type="text" class="form-control form-control-sm bg-secondary border-0 text-center" value="${c.amount }">
			                                    <div class="input-group-btn">
			                                        <button class="btn btn-sm btn-primary btn-plus" onclick="location.href='addAmountCart?productID=${p.id_P}&amount=${c.amount}';">
